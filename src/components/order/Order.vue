    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" icon="el-icon-edit" @click="showBox(scope.row.order_id)">编辑</el-button>
            <el-button size="mini" type="success" icon="el-icon-location" @click="showProgressBox(scope.row.id)">定位</el-button>
          </template>
        </el-table-column>
      </el-table>
